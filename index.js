...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.m7oglfl.mongodb.net/?retryWrites=true&w=majority`;
...
const run = async () => {
  try {
    ...
    const productCollenction = client.db("friendsmoto").collection("products");
    const userCollenction = client.db("friendsmoto").collection("users");
    const reviewCollenction = client.db("friendsmoto").collection("reviews");
    const orderCollenction = client.db("friendsmoto").collection("orders");
    const paymentCollenction = client.db("friendsmoto").collection("payments");
